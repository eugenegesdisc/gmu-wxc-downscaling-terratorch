"""
Module for testing GmuMerra2M2I1NXFLX dataset
"""
import logging
import pytest
...
class DecoTest2GmuMerra2M2T1NXFLX:
    """
    Test GmuMerra2M2T1NXFLX dataset
    """
    ...
    def deco_test_download(self)->bool:
        ...
        Test download
        """
        ds = GmuMerra2M2T1NXFLX(
            paths="../exp/m2t1nxflx/merra2",
            download=True,
            start_date="2000-12-31",
            end_date="2001-01-01",
            username="earthdata-username",
            password="earthdata-password",
            target_download_dir="../exp/m2t1nxflx/download")
        if not ds:
            return False
        return True
    ...
    def deco_test_getitem(self)->bool:
        ...
        print(data2["image"][ds.all_bands.index("Z0M"),:,:])
...
class Test2GmuMerra2M2T1NXFLX:
    ...
    def test_download(self):
        """
            Test download
        """
        dec_cls = DecoTest2GmuMerra2M2T1NXFLX()
