...
class DecoTest2GmuMerra2M2I1NXASM:
    """
    ...
    def deco_test_download(self)->bool:
        ...
        ds = GmuMerra2M2I1NXASM(
            paths="../exp/m2i1nxasm/merra2",
            download=True,
            start_date="2000-12-31",
            end_date="2001-01-01",
            username="earthdata-username",
            password="earthdata-password",
            target_download_dir="../exp/m2i1nxasm/download")
        if not ds:
            return False
        return True
    ...
    def deco_test_getitem(self)->bool:
        ...
        print(data2["image"][ds.all_bands.index("T2M"),:,:])
...
class Test2GmuMerra2M2I1NXASM:
    ...
    def test_download(self):
        """
            Test download
        """
        dec_cls = DecoTest2GmuMerra2M2I1NXASM()
