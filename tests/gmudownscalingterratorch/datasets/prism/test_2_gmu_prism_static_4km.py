"""
    Module for testing GmuPrismStatic4km dataset
"""
import logging
import pytest
...
class DecorableGmuPrismStatic4km:
    """
        Decorable class: Testing GmuPrismStatic4km dataset
    """
    ...
    def test_download(self)->bool:
        ...
        Download data
        """
        ds = GmuPrismStatic4km(
            paths="../exp/staticprism4km/prism",
            #bands=["ppt","tmax"],
            download=True,
            target_download_dir="../exp/staticprism4km/download"
        )
    ...
    def deco_test_get_len(self)->bool:
        ...
        ds = GmuPrismStatic4km(
            paths="../exp/staticprism4km/prism",
            download=False,
            target_download_dir="../exp/staticprism4km/prism",
            extract=False)
    ...
    def deco_test_getitem(self)->bool:
        ...
        """
        ds = GmuPrismStatic4km(
            paths="../exp/staticprism4km/merra2",
            download=False,
            target_download_dir="../exp/staticprism4km/download",
            bands=["dem"],
            extract=False)
...
#@pytest.mark.option1
class TestGmuPrismStatic4km:
    """
        Testing GmuPrismStatic4km dataset
    """
    @pytest.mark.option1
    def test_download(self):
        ...
        Download data
        """
        dec_cls = DecorableGmuPrismStatic4km()
